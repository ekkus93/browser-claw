...
- [ ] Append audit events for:
  ...
  - [ ] tool proposed/approved/rejected/edited; <!-- PARTIAL (Pass 64-68): approved->tool.executed, rejected->tool.rejected, denied->tool.denied, errored->tool.failed are all audited (toolRunner). NOT yet audited: "proposed" (the ToolCallProposal emission itself) and "edited" (approvalEdited is UI-only). Leave unticked until those two are added. -->
